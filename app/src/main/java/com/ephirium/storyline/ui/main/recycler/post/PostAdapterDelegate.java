...
import com.ephirium.storyline.ui.main.recycler.post.callback.PostCallback;

public class PostAdapterDelegate implements AdapterDelegate {

    private final com.ephirium.storyline.ui.main.recycler.post.callback.PostCallback callback;

    @SuppressWarnings("unused")
    public PostAdapterDelegate(){
        callback = new com.ephirium.storyline.ui.main.recycler.post.callback.PostCallback();
    }
    ...
    @Deprecated
    public PostAdapterDelegate(com.ephirium.storyline.ui.main.recycler.post.PostCallback callback){
