...
public class PostAdapter extends RecyclerView.Adapter<PostViewHolder> {
    ...
    @Deprecated
    public PostAdapter(PostCallback callback) {
        this.callback = new com.ephirium.storyline.ui.main.recycler.post.callback.PostCallback()
                .addOnClickCallback(callback::onClick)
                .addOnMoveCallback(callback::onMove)
                .addOnSwipeCallback(callback::onSwipe);
    }

    public PostAdapter(com.ephirium.storyline.ui.main.recycler.post.callback.PostCallback callback) {
