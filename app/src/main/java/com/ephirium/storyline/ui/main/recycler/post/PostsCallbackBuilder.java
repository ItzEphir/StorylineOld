...
public class PostsCallbackBuilder {
    ...
    public com.ephirium.storyline.ui.main.recycler.post.callback.PostCallback actual(){
        PostCallback callback = build();
        return new com.ephirium.storyline.ui.main.recycler.post.callback.PostCallback(callback::onClick)
